...
function showWelcome() {
    ...
    let dist = getDistance(104.07611488493345, 37.18432212684753, ipLoacation.result.location.lng, ipLoacation.result.location.lat); //经纬度替换成自己的位置
...
你距离站长大人约有<span>${dist}</span>公里，${posdesc}`;
}
